...
Rectangle{
    ...
    RowLayout{
     ...
     FolderDialog{
        ...
        onAccepted:{
            selectedFolderToSync=""
            selectedFolderToSync=siteFolderDialog.selectedFolder.toString()
            console.log("TMP: "+selectedFolderToSync)
            selectedFolderToSync=selectedFolderToSync.replace(/^(file:\/{2})/,"")
            console.log("FOLDER: "+selectedFolderToSync)
            siteStackBridge.updateSiteFolderValue(selectedFolderToSync)
            siteFolder.text=selectedFolderToSync
