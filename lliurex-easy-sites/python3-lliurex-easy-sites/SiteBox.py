...
class SiteBox(Gtk.VBox):
	...
	def new_site_box(self,siteId,cont,args=None):
		...
		if custom:
			self.core.screenshot.download_image(image_info)
		else:
			self.core.screenshot.set_from_file(image_info)
		...
		site_name.set_width_chars(20)
		site_name.set_max_width_chars(20)
		...
		site_autor=Gtk.Label()
		author=self.sites_list[siteId]["author"]
		site_autor.set_text(author)
		site_autor.set_margin_left(10)
		site_autor.set_margin_right(5)
		site_autor.set_margin_bottom(15)
		site_autor.set_width_chars(40)
		site_autor.set_max_width_chars(40)
		site_autor.set_xalign(-1)
		site_autor.set_ellipsize(Pango.EllipsizeMode.MIDDLE)
		site_autor.set_name("SITE_AUTHOR")
		
		site_autor.set_valign(Gtk.Align.START)
		hbox_site_description.pack_start(site_name,False,False,10)
		hbox_site_description.pack_start(site_autor,False,False,1)
